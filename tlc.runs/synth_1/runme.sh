...
HD_PWD='C:/Users/hp/Documents/BIT/FPGA/ClassProject/tlc/tlc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tlc_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tlc_wrapper.tcl
