...
HD_PWD='C:/Users/hp/Documents/BIT/FPGA/ClassProject/tlc/tlc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tlc_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tlc_wrapper.tcl -notrace
